...
- best form of humans in general (health, beauty by head first symmetry):
  ...
  - head first symmetry means: getting the jaw out / den Kiefer ablassen (AT YOUR OWN RISK!)
    ...
    - NUTRITION (DO NOT TRAIN WITH TOO MUCH ENERGY [beware: gluten], TRY: LITTLE BIT OF RICE and CORNED BEEF)
      - anything +ok+ (+gluten+ [regular! cases: BETTER rice], fat, sugar [beware: eye conn.]), just to have energy
      - but:
      ...
      - waking up with eye blockers? no candle necessary!
        - inner-vision-fight: imagining violence against eye blockers, it's in your system
          - darkness around you and closed eyes -- focus on eye blockers via:
            ...
            - BACKTRACE: agents depending on other agents to have a better lock, e.g: I can see a small agent and cannot really fight it out, but to search for some other object related to this small agent, I may find a bigger agent (inner vision of agents and level of endangerment expressed by size of agents?!), AND KICK THIS AGENT OUT (focus on it after discovery)
