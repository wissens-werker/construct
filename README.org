...
* TODO Niemand sollte hörig sein, mittels (sit) rinse den freien Willen wieder erlangen!
- genügend gute Überlegungen hier, auf die man hören kann? den eigenen Willen zu informieren...
- aber aus einer Harmonie des eigenen Körpers folgt nicht automatisch eine Harmonie der Gesellchaft, also bitte auch den Rest dieser Datei nicht vernachlässigen!
* TODO No one should obey, it's about getting the free will back via (sit) rinse!
- enough good reasoning around here to adhere to? to inform your will...
- but your bodily harmony does not imply social harmony, so please see rest of this file, too!
...
How to have a real world feedback loop NOT ONLY WITH ME? Just in the internet/web. Anyone can voice issues via "issues". And, maintainers, ppl who try to weigh arguments to optimize the construction via world-wide-wished-things and decide what's in what's not, WILL BE MANY, having the principle of neutrality in mind. (even if many more ppl having my SSH keys {digital cryptographic keys to manage this repository}, how to avoid edit war? [not speaking about the identity of the philosopher of reflection, but finding consent by objectivity, neutrality in our yet so fragile "community" -- optimizing everything, a very IMPERSONAL view: and it only makes sense this way if we think about managing humanity in general? to detach {to some degree} from your identity vs. star mode being the philosopher king [RIP so many impartials I mentioned some time ago in my todo.org]] & every night someone is invited to doubt me, in turn some more explanations produced {really worthwhile to do so...}; so many devils know it's serious and too hopeful devils get crushed in the meantime, again.)
...
=> also see: [[./news.org]] "reality management"
