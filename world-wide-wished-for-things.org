...
- men masturbating
  ...
  - how to let go? OF WHAT?
    - women less prone to have orgasm than men, bad conscious for men, women rather prone to have selfsex to have orgasm
    - to let go first for men via selfsex? to not even have the slightest possibility of a bad performance!!! (and luckily unreachability is in reach via rinse = no reflecting observer)
